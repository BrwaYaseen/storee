...
import { Check, Loader, Loader2Icon, Trash, Trash2, X } from "lucide-react"
            ...
            <div className=" mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                <div className={cn("lg:col-span-7",{
                   ...
                   isMounted && items.length === 0,
                    ...
                    <ul className={cn({"divide-y divide-gray-200 border-b border-t border-gray-200":
                        isMounted && items.length > 0
                    })}>
                                            ...
                                            <div>
                                                <div className=" flex justify-between">
                                                    <h3 className=" text-sm">
                                                        <Link href={`/product/${product.id}`} className=" font-medium text-gray-800 hover:text-gray-800">
                                                            {product.name}
                                                        </Link>
                                                    </h3>
                                                </div>
                    ...
                    <div className=" mt-6 space-y-4">
                        ...
                        <div className=" flex items-center justify-between border-t border-gray-200 pt-4">
                            ...
                            <div className=" text-sm font-medium text-gray-900">
                                {isMounted ? formatPrice(fee): <Loader2Icon className=" h-4 w-4 animate-spin text-muted-foreground"/>}
                            </div>
                        </div>
                        ...
                        <div className=" flex items-center justify-between border-t border-gray-200">
                            ...
                            {isMounted ? formatPrice(cartTotal + fee): <Loader2Icon className=" h-4 w-4 animate-spin text-muted-foreground"/>}
                            </div>
                        </div>
                    </div>
